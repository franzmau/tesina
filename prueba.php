          ...
          <div class="grid_8">
            <div  style="align-self: center;"class="block-1 top-5">
              <div class="block-1-shadow">
                  <h2 class="clr-6 p4"> <?php poner_nombre($id_examen); ?></h2>
                    <div class="pag">
                    <form class="form" method="post"  action="calificar.php">
                      <input type="hidden" name="ide" value=<?php echo "'".$id_examen. "'"; ?> >
                      <input type="hidden" name="inicio" value=<?php $fecha = new DateTime();
